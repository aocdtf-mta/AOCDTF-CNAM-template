...
Canevas de rédaction et support de cours destiné au (gros) chantier de création de contenus pédagogiques pour les formations octroyées à l'AOCDTF en association avec le CNAM. Des directives de rédactions seront ajoutées au fur et à mesure de l'avancement du projet, pour standariser les contenus au mieux et permettre de produire des documents de qualités.
...
1. Se référer au dépôt [AOCDTF-package](https://github.com/aocdtf-mta/AOCDTF-package) pour l'installation de tous les packages et logiciels permettant d'initialiser sans accroc la compilation du canevas.
